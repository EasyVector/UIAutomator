...
public class DumpCommand extends Command {
    ...
    private static final File DEFAULT_DUMP_FILE = new File("/sdcard/window_dump.xml");
    ...
    public void run(String[] args) {
        ...
        try {
            ...
            System.out.println(
                    String.format("Views: %s", String.valueOf(rootViewNames.length)));

//            Class DisplayManagerGlobalDummy = Class.forName("android.hardware.display.DisplayManagerGlobal");
//            Object UiAutomationConnectionObject = DisplayManagerGlobalDummy.getDeclaredConstructor().newInstance();
            Class DisplayManagerGlobal = Class.forName("android.hardware.display.DisplayManagerGlobal");
            Method getInstanceMethod = DisplayManagerGlobal.getMethod("getInstance");
            Method getRealDisplay = DisplayManagerGlobal.getMethod("getRealDisplay", int.class);
            Object instanceResult = getInstanceMethod.invoke(null);
            Display display = (Display) getRealDisplay.invoke(instanceResult, Display.DEFAULT_DISPLAY);
